...
#tiles de la habitacion

tile_tamaño = 32 # Tamaño de cada tile
tile_x = 20 // tile_tamaño # posicion de x de la habitacion
tile_y = 18 // tile_tamaño# posicion de y de la habitacion
...
def hay_colision(x, y)  
    #los obstaculos de la habiacion
    for i in obstaculos_habitacion:     
        tile_col = x // tile_tamaño
        tile_fila = y // tile_tamaño
        if i == tile_col and i == tile_fila:
            return tile_index in obstaculos_habitacion
